      ...
      <section className=" invoice-sec bn-sec">
        ...
        <div className="in-wrapper">
          ...
          <div className="in-btm">
            ...
            <p className="in-para">
              Your order number is <span className="order-id">#FGFS3453476</span> . Your order was placed successfully and you will soon receive your order confirmation via email.
            </p>
            <div className="in-btn">
              <button className="in-btn-in">
                Download invoice
              </button>
              <button>
                Track order
